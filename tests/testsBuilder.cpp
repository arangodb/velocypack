...
TEST(BuilderTest, ShortStringViaValuePair) {
  ...
  static uint8_t correctResult[] = {
    0x6c, 0x74, 0x68, 0x65, 0x20, 0x71, 0x75, 0x69, 0x63, 0x6b, 0x20, 0x62, 0x72, 0x6f, 0x77, 0x6e, 
    0x20, 0x66, 0x6f, 0x78, 0x20, 0x6a, 0x75, 0x6d, 0x70, 0x65, 0x64, 0x20, 0x6f, 0x76, 0x65, 0x72,
...
TEST(BuilderTest, LongStringViaValuePair) {
  char const* p = "the quick brown fox jumped over the lazy dog, and it jumped and jumped and jumped and went on. But then, the String needed to get even longer and longer until the test finally worked.";
  ...
  static uint8_t correctResult[] = {
    0xbf, 0xb7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x74, 0x68, 0x65, 0x20, 0x71, 0x75, 0x69, 
    ...
    
  };
...
TEST(BuilderTest, CustomViaValuePair) {
  ...
  static uint8_t correctResult[] = {
    0xf0, 0x74, 0x68, 0x65, 0x20, 0x71, 0x75, 0x69, 0x63, 0x6b, 0x20, 0x62, 0x72, 0x6f, 0x77, 0x6e, 
    0x20, 0x66, 0x6f, 0x78, 0x20, 0x6a, 0x75, 0x6d, 0x70, 0x65, 0x64, 0x20, 0x6f, 0x76, 0x65, 0x72,
    0x20, 0x74, 0x68, 0x65, 0x20, 0x6c, 0x61, 0x7a, 0x79, 0x20, 0x64, 0x6f, 0x67
};
...
TEST(BuilderTest, InvalidTypeViaValuePair) {
  ...
  Builder b;
  ASSERT_VELOCYPACK_EXCEPTION(b.add(ValuePair(p, strlen(p), ValueType::UTCDate)), Exception::BuilderUnexpectedType);
}
...
TEST(BuilderTest, AttributeTranslationsRollbackSet) {
  ...
  Builder b(&options);
  b.add(Value(ValueType::Object));
  ASSERT_VELOCYPACK_EXCEPTION(b.add("foo", Value(ValueType::Custom)), Exception::BuilderUnexpectedType);
  ASSERT_VELOCYPACK_EXCEPTION(b.add("FOOBAR", Value(ValueType::Custom)), Exception::BuilderUnexpectedType);
}
