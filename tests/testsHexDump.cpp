...
TEST(HexDumpTest, TestArray) {
  ...
  EXPECT_EQ("0x06 0x18 0x0a 0x31 0x32 0x33 0x34 0x35 0x36 0x37 0x38 0x39 0x28 0x0a 0x03 0x04\n0x05 0x06 0x07 0x08 0x09 0x0a 0x0b 0x0c", out.str());
}
...
TEST(HexDumpTest, TestEmptySeparator) {
  ...
  EXPECT_EQ("0x060x180x0a0x310x320x330x340x350x360x370x380x390x280x0a0x030x04\n0x050x060x070x080x090x0a0x0b0x0c", out.str());
}
