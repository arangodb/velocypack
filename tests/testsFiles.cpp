...
TEST(StaticFilesTest, CommitsJson) {
  ASSERT_TRUE(parseFile("commits.json"));
}

TEST(StaticFilesTest, SampleJson) {
  ASSERT_TRUE(parseFile("sample.json"));
}
...
TEST(StaticFilesTest, SmallJson) {
  ASSERT_TRUE(parseFile("small.json"));
}

TEST(StaticFilesTest, Fail2Json) {
  ASSERT_FALSE(parseFile("fail2.json"));
}

TEST(StaticFilesTest, Fail3Json) {
  ASSERT_FALSE(parseFile("fail3.json"));
}

TEST(StaticFilesTest, Fail4Json) {
  ASSERT_FALSE(parseFile("fail4.json"));
}

TEST(StaticFilesTest, Fail5Json) {
  ASSERT_FALSE(parseFile("fail5.json"));
}

TEST(StaticFilesTest, Fail6Json) {
  ASSERT_FALSE(parseFile("fail6.json"));
}

TEST(StaticFilesTest, Fail7Json) {
  ASSERT_FALSE(parseFile("fail7.json"));
}

TEST(StaticFilesTest, Fail8Json) {
  ASSERT_FALSE(parseFile("fail8.json"));
}

TEST(StaticFilesTest, Fail9Json) {
  ASSERT_FALSE(parseFile("fail9.json"));
}

TEST(StaticFilesTest, Fail10Json) {
  ASSERT_FALSE(parseFile("fail10.json"));
}

TEST(StaticFilesTest, Fail11Json) {
  ASSERT_FALSE(parseFile("fail11.json"));
}

TEST(StaticFilesTest, Fail12Json) {
  ASSERT_FALSE(parseFile("fail12.json"));
}

TEST(StaticFilesTest, Fail13Json) {
  ASSERT_FALSE(parseFile("fail13.json"));
}

TEST(StaticFilesTest, Fail14Json) {
  ASSERT_FALSE(parseFile("fail14.json"));
}

TEST(StaticFilesTest, Fail15Json) {
  ASSERT_FALSE(parseFile("fail15.json"));
}

TEST(StaticFilesTest, Fail16Json) {
  ASSERT_FALSE(parseFile("fail16.json"));
}

TEST(StaticFilesTest, Fail17Json) {
  ASSERT_FALSE(parseFile("fail17.json"));
}

TEST(StaticFilesTest, Fail19Json) {
  ASSERT_FALSE(parseFile("fail19.json"));
}

TEST(StaticFilesTest, Fail20Json) {
  ASSERT_FALSE(parseFile("fail20.json"));
}

TEST(StaticFilesTest, Fail21Json) {
  ASSERT_FALSE(parseFile("fail21.json"));
}

TEST(StaticFilesTest, Fail22Json) {
  ASSERT_FALSE(parseFile("fail22.json"));
}

TEST(StaticFilesTest, Fail23Json) {
  ASSERT_FALSE(parseFile("fail23.json"));
}

TEST(StaticFilesTest, Fail24Json) {
  ASSERT_FALSE(parseFile("fail24.json"));
}

TEST(StaticFilesTest, Fail25Json) {
  ASSERT_FALSE(parseFile("fail25.json"));
}

TEST(StaticFilesTest, Fail26Json) {
  ASSERT_FALSE(parseFile("fail26.json"));
}

TEST(StaticFilesTest, Fail27Json) {
  ASSERT_FALSE(parseFile("fail27.json"));
}

TEST(StaticFilesTest, Fail28Json) {
  ASSERT_FALSE(parseFile("fail28.json"));
}

TEST(StaticFilesTest, Fail29Json) {
  ASSERT_FALSE(parseFile("fail29.json"));
}

TEST(StaticFilesTest, Fail30Json) {
  ASSERT_FALSE(parseFile("fail30.json"));
}

TEST(StaticFilesTest, Fail31Json) {
  ASSERT_FALSE(parseFile("fail31.json"));
}

TEST(StaticFilesTest, Fail32Json) {
  ASSERT_FALSE(parseFile("fail32.json"));
}

TEST(StaticFilesTest, Fail33Json) {
  ASSERT_FALSE(parseFile("fail33.json"));
}
