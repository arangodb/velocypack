...
GitHub Action: [![Build](https://github.com/arangodb/velocypack/actions/workflows/cmake.yaml/badge.svg)] Coveralls: [![Coverage Status](https://coveralls.io/repos/arangodb/velocypack/badge.svg?branch=main&service=github)](https://coveralls.io/github/arangodb/velocypack?branch=main)
